        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Logo = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CoverPicture = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fax = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MainBranch = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    OpenTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    CloseTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopBranchs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShopBranchs_Shops_ShopId",
                        column: x => x.ShopId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShopBranchId = table.Column<long>(type: "bigint", nullable: false),
                    ShopId = table.Column<long>(type: "bigint", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    Updated = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    CreatedBy = table.Column<string>(type: "longtext", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_ShopBranchs_ShopBranchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShopBranchs_ShopId",
                table: "ShopBranchs",
                column: "ShopId");

            migrationBuilder.CreateIndex(
                name: "IX_Users_ShopBranchId",
                table: "Users",
                column: "ShopBranchId");
